...
Hooks.once("ironswornOracleTreesReady", async () => {
  if (game.settings.get('ironsmith-expanded-oracles', 'enableOraclesInTree')) {
    ...
    let characterFolder = ironswornOracles.children.find(children => children.displayName === "Character");
    let characterIndex = ironswornOracles.children.indexOf(characterFolder);
    ...
    ironswornOracles.children.splice(combatEventIndex + 1, 0, {
    ...
    ironswornOracles.children.splice(featureIndex + 1, 0, {
    ...
    let nameIndex = ironswornOracles.children.indexOf(ironswornOracles.children.find(children => children.displayName === "Name"));

    ironswornOracles.children.splice(nameIndex + 1, 0, {
      displayName: 'Other',
      tables: [],
      children: []
    });
    ...
    ironswornOracles.children.splice(turningPointIndex + 1, 0, {
      displayName: 'Vows',
      tables: [],
      children: []
    });
